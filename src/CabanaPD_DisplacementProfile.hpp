...
auto createDisplacementProfile( MPI_Comm comm, const int num_cell,
                                ...
                                ParticleType particles )
{
    ...
    createDisplacementProfile( comm, num_cell, profile_dim, file_name,
                               particles, value );
}

template <typename ParticleType>
auto createDisplacementMagnitudeProfile( MPI_Comm comm, const int num_cell,
