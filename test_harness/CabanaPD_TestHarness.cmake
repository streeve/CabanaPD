macro(CabanaPD_add_tests)
  cmake_parse_arguments(CABANAPD_UNIT_TEST "MPI;REGRESSION" "" "NAMES" ${ARGN})
  ...
  set(CABANAPD_UNIT_TEST_MAIN ${TEST_HARNESS_DIR}/mpi_unit_test_main.cpp)
  ...
  foreach(_device SERIAL PTHREAD OPENMP CUDA HIP)
    if(Kokkos_ENABLE_${_device})
      ...
      foreach(_test ${CABANAPD_UNIT_TEST_NAMES})
        ...
        if(CabanaPD_UNIT_TEST_REGRESSION)
          set(_target CabanaPD_RegressionTest_${_test}_${_uppercase_device})
        else()
          set(_target CabanaPD_UnitTest_${_test}_${_uppercase_device})
        endif()
  
        add_executable(${_target} ${_file} ${CABANAPD_UNIT_TEST_MAIN})
        target_include_directories(${_target} PRIVATE ${_dir} ${CMAKE_CURRENT_SOURCE_DIR} ${TEST_HARNESS_DIR})
